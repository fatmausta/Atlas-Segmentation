...
atlas_dataset = ['0515', '0485', '0495', '0529', '0565', '0578', '0715', '1115', '1168']# 2 more atlas dataset down there to change
target_dataset = ['0515', '0485', '0495', '0529', '0565', '0578', '0715', '1115', '1168']#, '0515', '0529', '0565', '0578', '0715', '1115', '1168']#, '0495', '0515', '0529', '0565', '0578',  '0715', '1115', '1168']#['0485', '0546', '0578', '1168', '0715'] #have to use only one target
target_dataset2 = ['0515', '0485', '0495', '0529', '0565', '0578', '0715', '1115', '1168']#, '0515', '0529', '0565', '0578', '0715', '1115', '1168']#, '0495', '0515', '0529', '0565', '0578',  '0715', '1115', '1168']#['0485', '0546', '0578', '1168', '0715'] #for JLF, copy of target_dataset
...
for target_id in target_dataset: #target dataset for cross_correlation, if no cross-correlation, uses only one target
    ...
    atlas_dataset = ['0515', '0485', '0495', '0529', '0565', '0578', '0715', '1115', '1168']
    ...
    for a in atlas_dataset:
        ...
        if LGEtoMRA_registerResampleFlag == True:
            ...
            flo_lbl3 = os.path.join(data_root, a, 'myo' + a + '_smooth.nii')
